...
var tmpIdTareaMO = 0, tmpValorTDesc;
var tmpIdTareaMO2 = 0, tmpvalorTDesc2;
...
function eliminarTareaH(idImpSel, idTareaSel) {
    $("#tblDetalleProyecto").treetable("removeNode", idImpSel);
    if (idTareaSel in mapEdiciones) {
        var tmpTarea = mapEdiciones[idTareaSel];
        if (tmpTarea.accion === "a") {
